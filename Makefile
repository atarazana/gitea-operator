...
# opentlc.com/gitea-operator-bundle:$VERSION and opentlc.com/gitea-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= opentlc.com/gitea-operator
...
ifeq (,$(shell which ansible-operator 2>/dev/null))
	...
	curl -sSLo $(ANSIBLE_OPERATOR) https://github.com/operator-framework/operator-sdk/releases/download/v1.6.4/ansible-operator_$(OS)_$(ARCH) ;\
